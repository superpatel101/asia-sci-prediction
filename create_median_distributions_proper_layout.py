...
Better spacing for Grade D visibility
"""
...
print("Creating median-only distribution figure with proper layout...")
...
for idx, grade_num in enumerate(grades):
    ...
    # Grade D needs fewer bins since it has very few samples
    if grade_num == 4:  # Grade D
        # With only 39 samples, use fewer bins for better visibility
        bins = 15
    ...
    # Add ONLY median line (darker green, thicker)
...
print("\n" + "-"*70)
print("TREND: Medians generally DECREASE from A→B→C→D (32→27→23→18)")
print("       Grade E has intermediate median (29 days)")
print("="*70)

print("\n✓ Figure created successfully with proper 3-over-2 layout!")
